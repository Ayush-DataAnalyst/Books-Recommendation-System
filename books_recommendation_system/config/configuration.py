...
class AppConfiguration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            artifact_dir = self.configs_info['artifact_config']['artifact_dir']
            dataset_dir = data_ingestion_config['dataset_dir']

            ingested_data_dir = os.path.join(artifact_dir, data_ingestion_config['ingested_dir'])
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            data_ingestion_config = self.configs_info['data_ingestion_config']
            dataset_dir = data_ingestion_config['dataset_dir']
            artifact_dir = self.configs_info['artifact_config']['artifacts_dir']
            ...
            clean_data_path = os.path.join(artifact_dir, dataset_dir, data_validation_config['clean_data_dir'])
            serialized_objects_dir = os.path.join(artifact_dir, data_validation_config['serialized_objects_dir'])
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            clean_data_file_path = os.path.join(artifact_dir, dataset_dir, data_validation_config['clean_data_dir'],'clean_data.csv')
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            transformed_data_file_dir = os.path.join(artifact_dir, dataset_dir, data_transformation_config['transformed_data_dir'], 'transformed_data.pkl')
    ...
    def get_recommendation_config(self) -> ModelRecommendationConfig:
        try:
            ...
            book_name_serialized_objects = os.path.join(artifact_dir, data_validation_config['serialized_objects_dir'], 'book_names.pkl')
            book_pivot_serialized_objects = os.path.join(artifact_dir, data_validation_config['serialized_objects_dir'], 'book_pivot.pkl')
            final_rating_serialized_objects = os.path.join(artifact_dir, data_validation_config['serialized_objects_dir'], 'final_rating.pkl')
